...
class test_buylcquery20024(unittest.TestCase):
	...
	def test_body(self):
		...
		print("购买中出借查询__20024接口&&==客户编号：" + self.custCode)
		self.data = {
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, "0000", self.logger.info("检查是否购买中出借查询成功"))
