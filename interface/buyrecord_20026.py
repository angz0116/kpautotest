...
class test_buyrecord20026(unittest.TestCase):
	...
	def test_body(self):
		...
		print("购买记录__20026接口&&==客户编号：" + self.custCode+"&&产品代码："+self.productCode)
		self.data = {
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, "0000", self.logger.info("检查是否购买记录查询成功"))
