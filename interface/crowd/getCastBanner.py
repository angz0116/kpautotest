...
interfaceNo = "getCastBanner"
name = "组织图片banner图跳转配置"

req = ConfigHttp()


@paramunittest.parametrized(*get_xls("interfaces.xls", interfaceNo))
class 组织图片banner图跳转配置(unittest.TestCase):
    ...
    def check_result(self):
        try:
            self.assertEqual(self.retcode, 0, self.logger.info("是否获取组织图片banner图跳转配置"))
