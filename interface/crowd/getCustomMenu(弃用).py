...
class 获取自定义菜单(unittest.TestCase):
    ...
    def test_body(self):
        ...
        # 机构id
        self.pid = get_excel("crowdid", self.No, interfaceNo)
        self.data = {
    ...
    def check_result(self):
        try:
            self.assertEqual(self.retcode, 0, self.logger.info("是否获取自定义菜单"))
