...
class test_investzquery20023(unittest.TestCase):
	...
	def test_body(self):
		...
		print("出借、转让查询__20023接口&&==客户编号：" + self.custCode)
		self.data = {
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, "0000", self.logger.info("检查是否出借，转让查询成功"))
