...
class test_authorizeqx20126(unittest.TestCase):
	...
	def test_body(self):
		...
		# 客户编号
		self.ecifId = get_excel("custCode", self.No, "20124")
		# 获取当前时间
		...
		print("存管客户授权取消__20126接口&&==客户编号：" + self.ecifId)
		self.data = {
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, "0000", self.logger.info("检查是否取消授权成功"))
