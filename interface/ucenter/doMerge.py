...
class 账号合并(unittest.TestCase):
    def setParameters(self, No, 测试结果, 请求报文, 返回报文, 测试用例, url, retainuid, mergeduid ,预期结果):
        self.No = str(No)
        self.url = str(url)
        self.retainuid = str(retainuid)
        self.mergeduid = str(mergeduid)
    ...
    def test_body(self):
        ...
        self.data = {
            "retain_uid": self.retainuid,
            "merged_uid": self.mergeduid,
            "system": "5",
