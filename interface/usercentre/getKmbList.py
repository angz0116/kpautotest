...
class 获取科界榜列表(unittest.TestCase):
    ...
    def test_body(self):
        req.httpname = "KPTEST"
        # 类型: total_check是连续签到 score1是积分数量，con_check是累计签到
    ...
    def check_result(self):
        try:
            self.assertEqual(self.retcode, 0, self.logger.info("是否获取科界榜列表"))
