...
class test_wdquery20062(unittest.TestCase):
	def setParameters(self, No, 测试结果, 请求报文, 返回报文, 查询SQL,custCode, status):
		self.No = str(No)
	...
	def test_body(self):
		...
		print("提现查询__20062接口&&==客户编号：" + self.custCode + "&&==银行卡号：" + self.bankAcctNo)
		self.data = {
	...
	def check_result(self):
		try:
			self.assertEqual(self.retcode, "0000", self.logger.info("检查是否提现查询成功"))
